"""
 ...
 Date : June 22th 2016
 Perceptron classifier with feature selection for ARFF traffic network file
"""

import time

from extraction_feature import load_dataset, split_data, kfold_data
...
def main():
    ...
    """Building training_set and test_set (split or KFold) """
