...
static const char *const yytname[] =
{
  ...
  "byteorder", "size", "output", "identifier", "nextfile", YY_NULLPTR
};
#endif
...
#line 45 "parser.y" /* yacc.c:1646  */
    { 
		...
		new_field->order = (yyvsp[-3].intval);
		new_field->size = (yyvsp[-2].intval);
		new_field->display = (yyvsp[-1].intval);
		new_field->identifier = (yyvsp[0].textval);
...
#line 86 "parser.y" /* yacc.c:1646  */
    { (yyval.textval) = strdup((yyvsp[0].textval)); }
...
#line 90 "parser.y" /* yacc.c:1646  */
    { 
		...
		nextheader->prefix = (yyvsp[-1].textval);
		nextheader->fieldname = (yyvsp[0].textval);
		...
		for(tmp = el_list ;; tmp=tmp->next)
		{
		     ...
		     */
		    if(strcmp((yyvsp[0].textval), tmp->data->field->identifier) == 0)
		    {
